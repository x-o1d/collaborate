"use strict";
(self["webpackChunkgame_theory"] = self["webpackChunkgame_theory"] || []).push([[179],{
...
;// CONCATENATED MODULE: ./src/app/components/fire.tsx
...
;// CONCATENATED MODULE: ./src/app/components/player.tsx
...
function Player({
  ...
  if (!playerData.alive) {
    ...
    return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Fire, {
        color: 'blue',
        location: playerData.location,
        shoot: playerData.assist
      }), /*#__PURE__*/(0,jsx_runtime.jsx)(Fire, {
...
const toRadian = degrees => degrees / 180 * Math.PI;
...
const resetPlayers = iteration => Array(NUM_PLAYERS * 2).fill({}).map((_, index) => {
  return {
    ...
    team: index % 2,
    location: {
      x: Math.floor(Math.random() * (ARENA_SIZE - 2 * PLAYER_RANGE) + PLAYER_RANGE),
      y: Math.floor(Math.random() * (ARENA_SIZE - 2 * PLAYER_RANGE) + PLAYER_RANGE)
    }
  };
});
function App() {
  const [render, setRender] = (0,react.useState)(false);
  const [gameCount, setGameCount] = (0,react.useState)(0);
  const [players, setPlayers] = (0,react.useState)(() => resetPlayers(0));
  const [collaborate, setCollaborate] = (0,react.useState)([1, 0]);
  const gameRunning = (0,react.useRef)(false);
  const gameStartedAt = (0,react.useRef)(new Date().getTime());
  const wins = (0,react.useRef)(new Array());
  const winReason = (0,react.useRef)(new Array());
  const searchForOpponents = (0,react.useCallback)(() => {
    players.forEach(player => {
      ...
      if (player.state < 0) {
        ...
        players.forEach((player2, index) => {
          ...
          if (player2.state >= 0) {
            const distance = Math.sqrt(Math.pow(player.location.x - player2.location.x, 2) + Math.pow(player.location.y - player2.location.y, 2));
            // if distance is smaller than the closest opponent already found
            if (distance < minDistance) {
              if (distance > PLAYER_RANGE && distance < PLAYER_RANGE * 5 * collaborate[player.team]) {
        ...
        // assist team mate
        if (player.assist) {
          player.direction = Math.atan2(player.assist.y - player.location.y, player.assist.x - player.location.x);
          ...
          if (Math.random() < PLAYER_RANDOMNESS) {
            ...
            player.direction += (Math.random() - directionChange) * MAX_CHANGE_DIRECTION;
          }
        }
  ...
  const checkAndFire = (0,react.useCallback)(() => {
    players.forEach(player1 => {
      ...
      players.forEach(player2 => {
        ...
        const distance = Math.sqrt(Math.pow(player1.location.x - player2.location.x, 2) + Math.pow(player1.location.y - player2.location.y, 2));
  ...
  const removePlayers = (0,react.useCallback)(() => {
    players.forEach(player1 => {
      if (player1.health <= 0) {
        player1.alive = false;
        player1.shoot = undefined;
  ...
  const checkEndGame = (0,react.useCallback)(() => {
    let endGame = true;
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      ...
      children: players.map(player => /*#__PURE__*/(0,jsx_runtime.jsx)(Player, {
        playerData: player
      }, player.id))
    }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      className: "description",
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        children: "When collaboration is at max, a player responds to an assist call within five times it's firing range."
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        children: "When collaboration is at min, a player responds to an assist call only within it's firing range."
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        children: "A red line is a shot by the sportsbet team"
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        children: "A green line is a shot by the sportsbet team"
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        children: "A blue line is a player responding to an assist call"
      })]
    }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      className: "wins",
      children: [teams.map((team, index) => /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        style: {
          color: team.color
        },
        children: `Team ${team.name} wins: ${team.wins / gameCount * 100}%`
      }, index)), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        className: "controls",
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          children: "Collaborate amused"
          ...
          children: "Collaborate sportsbet"
        }), /*#__PURE__*/(0,jsx_runtime.jsx)("input", {
          disabled: gameRunning.current,
          type: "range",
      ...
      children: wins.current.map((win, index) => /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        children: `Team ${teams[win].name} won ${winReason.current[index]}`
      }, index))
    })]
  });
}
